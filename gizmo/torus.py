...
class SDFTorusWidgetGroup(GizmoGroup):
    ...
    def setup(self, context):
        ...
        gz_radius_0.target_set_handler("offset", get=move_get_height, set=move_set_height)
        ...
        gz_radius_1.target_set_handler("offset", get=move_get_radius, set=move_set_radius)
